...
const Card = ({ className, children }: Wrapper): JSX.Element => {
	return (
		<div className="group group relative flex transform cursor-pointer flex-wrap border border-zinc-300 bg-opacity-50 p-px py-px transition duration-200 hover:scale-105 ">
